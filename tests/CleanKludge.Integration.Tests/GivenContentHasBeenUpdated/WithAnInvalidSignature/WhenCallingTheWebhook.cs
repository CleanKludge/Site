...
namespace CleanKludge.Integration.Tests.GivenContentHasBeenUpdated.WithAnInvalidSignature
{
    [TestClass]
    public class WhenCallingTheWebhook
    {
        ...
        public async Task SetUp()
        {
            ...
            _result = await Given.AHttpClientWithInMemoryCache()
                ...
                .With(client => client.DefaultRequestHeaders.Add("X-Hub-Signature", "sha2=44d619a0e03b21f2de6517db604fcf91294240c7"))
